...
const DOMESTIC_AIRLINES = [
    ...
    },
    {
        id: 'airindia',
        name: 'Air India',
        url: 'https://www.airindia.com/in/en/book/manage-booking/web-checkin.html',
        color: '#ED1B24'
    },
    {
        id: 'vistara',
    ...
    },
    {
        id: 'spicejet',
        name: 'SpiceJet',
        url: 'https://www.spicejet.com/check-in',
        color: '#F98616'
    },
    {
        id: 'akasa',
        name: 'Akasa Air',
        url: 'https://www.akasaair.com/web-check-in',
        color: '#FF6400'
    },
    {
        id: 'airindiaexpress',
        name: 'Air India Express',
        url: 'https://www.airindiaexpress.com/check-in',
        color: '#ED1E24'
    }
];
...
const AirlineCard = ({ airline }: { airline: { id: string, name: string, url: string, color: string } }) => (
    <Card
        className="group relative overflow-hidden bg-white hover:bg-gray-50 border-gray-100 transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:-translate-y-1 rounded-2xl"
    >
        <CardContent className="p-6">
            <div className="flex items-start justify-between mb-4">
                <div
                    className="w-12 h-12 rounded-xl flex items-center justify-center transition-colors shadow-sm"
                    style={{ backgroundColor: `${airline.color}10`, color: airline.color }}
                >
                ...
                <a
                    ...
                    className="p-2 text-gray-400 hover:text-brand transition-colors bg-gray-50 rounded-lg"
                >
                    <ExternalLink className="w-4 h-4" />
                </a>
            </div>

            <h3 className="font-heading tracking-tight font-bold text-lg text-gray-900 mb-1 truncate" title={airline.name}>
                {airline.name}
            </h3>
            ...
            <Button
                asChild
                className="w-full h-11 bg-gray-950 hover:bg-brand text-white rounded-xl font-bold text-xs transition-all shadow-md group-hover:scale-[1.02]"
            >
                <a
                    href={airline.url}
                    target="_blank"
    ...
    return (
        <main className="min-h-screen bg-gray-50/50 py-24 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {/* Domestic Airlines Section */}
                <div className="mb-24">
                    <div className="flex items-center justify-between gap-6 mb-10">
                        <h2 className="text-xs font-bold text-gray-400 flex items-center gap-2 shrink-0">
                ...
                <div className="mb-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {INTERNATIONAL_AIRLINES.map((airline) => (
                            <AirlineCard key={airline.id} airline={airline} />
                        ))}
                    </div>
                </div>

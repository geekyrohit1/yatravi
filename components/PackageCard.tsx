  ...
  if (variant === 'horizontal') {
    return (
      ...
      >
        ...
        <div className="relative w-full max-w-[calc(100vw-32px)] md:w-[260px] lg:w-[300px] aspect-[1.2/1] md:aspect-auto shrink-0 p-1.5 bg-white">
        ...
        <div className="p-3 md:p-4 flex-1 flex flex-col justify-between relative bg-white min-w-0">
          ...
          <div className="flex-1 min-w-0 px-1">
            ...
            <h3 className="text-[17px] md:text-[19px] font-heading font-medium text-gray-900 mb-1.5 leading-tight lg:group-hover:text-brand transition-colors tracking-tight truncate">
              {pkg.title}
            </h3>
            ...
            <div className="flex items-center gap-3 mb-2.5">
              <div className="flex items-center gap-1.5 bg-gray-50/80 px-2.5 py-1 rounded-md border border-gray-100/50">
                ...
                <span className="text-[11px] text-gray-600 font-bold tracking-tight">
              ...
              <div className="flex items-center gap-1.5 bg-orange-50/50 px-2.5 py-1 rounded-md border border-orange-100/30">
                ...
                <span className="text-[11px] text-brand font-bold" translate="no">{pkg.rating}</span>
                <span className="text-[10px] text-gray-400 font-medium ml-0.5">
                  <span>(</span>
                  <span translate="no">{pkg.reviewsCount}</span>
                  <span> reviews)</span>
                </span>
              </div>
            </div>
                ...
                {stays.map((stay, idx) => (
                  <React.Fragment key={idx}>
                    <div className="flex items-center gap-1">
                      <span className="text-[10px] md:text-[11px] font-bold text-gray-900" translate="no">{stay?.nights}</span>
                      <span className="text-[9px] font-extrabold text-[#fb5012] uppercase tracking-tighter">Stay</span>
                      {stay?.location && (
                        <span className="text-[10px] md:text-[11px] text-gray-700 font-medium ml-0.5">
                          {stay.location}
                        </span>
                      )}
                    </div>
  ...
  return (
    <>
      ...
      >
        ...
        {/* Image Section - Framed Look */}
        <div className="relative aspect-[1.1/1] sm:aspect-[1.15/1] p-1.5 bg-white">
          <div className="relative w-full h-full rounded-lg overflow-hidden transform-gpu">
            <Image
        ...
        <div className="p-3.5 md:p-2 lg:p-3.5 flex-1 flex flex-col">
          <div className="mb-1">
            <h3 className="text-[16px] md:text-[12.5px] lg:text-[16px] font-heading font-medium text-gray-900 leading-[1.2] tracking-tight lg:group-hover:text-brand transition-colors truncate">
              {pkg.title}
            </h3>
          </div>
          ...
          <div className="mt-auto">
            ...
            <div className="flex gap-2.5">
              ...
              <button
                onClick={() => router.push(`/packages/${pkg.slug || pkg.id}`)}
                className="flex-1 bg-brand text-white font-semibold h-11 md:h-12 rounded-lg flex items-center justify-center gap-1 hover:shadow-lg hover:shadow-brand/20 transition-all text-[11px] md:text-[11px] uppercase tracking-wider px-2 md:px-8 whitespace-nowrap"
              >
